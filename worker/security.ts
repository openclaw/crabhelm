...
import type { InvocationGrantClaims, PrincipalRole, RuntimeClaims, SessionClaims } from "../src/governance-types.js";

type Claims = InvocationGrantClaims | SessionClaims | RuntimeClaims;
