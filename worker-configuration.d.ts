/* eslint-disable */
// Wrangler runtime types with environment values deliberately generalized to strings.
// Runtime types generated with workerd@1.20260701.1 2026-07-02 nodejs_compat
interface __BaseEnv_Env {
	APPLIANCES: R2Bucket;
	OAUTH_VAULT: R2Bucket;
	...
	CRABHELM_EGRESS_LOCKDOWN: string;
	CRABHELM_MODEL_PROXY: string;
	NODE_RUNTIME_SHA256: string;
	APPLIANCE_ARCHIVE_SHA256: string;
	APPLIANCE_MANIFEST_SHA256: string;
	CONTROL_PLANE: DurableObjectNamespace<import("./worker/index").CrabhelmControlPlane>;
	CLAW_COORDINATOR: DurableObjectNamespace<import("./worker/index").CrabhelmClawCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "CrabhelmControlPlane" | "CrabhelmClawCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_URL" | "RUNTIME_URL" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "CF_ACCESS_ADMIN_EMAILS" | "CF_ACCESS_ADMIN_GROUPS" | "CRABHELM_PROBE_EMAIL" | "GITHUB_OAUTH_CLIENT_ID" | "CRABBOX_URL" | "CRABBOX_TARGET_ID" | "CRABBOX_TARGET_LABEL" | "CRABBOX_TARGET_REGION" | "CRABBOX_PROFILE" | "CRABBOX_TTL_SECONDS" | "CRABBOX_IDLE_TIMEOUT_SECONDS" | "CRABHELM_EGRESS_LOCKDOWN" | "CRABHELM_MODEL_PROXY" | "NODE_RUNTIME_SHA256" | "APPLIANCE_ARCHIVE_SHA256" | "APPLIANCE_MANIFEST_SHA256">> {}
}
