...
Before live FakeCo validation, build and upload the reviewed OpenClaw `2026.7.1` appliance from stable source commit `2d2ddc43d0dcf71f31283d780f9fe9ff4cc04fe4` plus upstream managed-ClawRouter backport `6db586a388c639796e312811b4d9801ca6ce1806` and SQLite plugin-metadata migration backport `ef110e9a0f42e5c99d56f0126e7e42c4284865aa`, then pin its exact manifest, archive, and Node digests in this stack. The disposable Crabbox route and runtime-bridge canary proves the profile; it does not replace a full FakeCo deployment.
