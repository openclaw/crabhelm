...
- Worker version: `2a567966-2ca0-4efe-803d-e45c46950e0d`.
...
- A fresh existing-profile GitHub login matched the `openclaw` organization rule, resolved `steipete@gmail.com`, returned `administrator, member`, and rendered Fleet successfully.
